...
function ClosingCTA() {
  ...
  }, "Takes 30 seconds. Admin perms required for /server_setup. Always free."), React.createElement("div", {
    style: {
      display: 'flex',
      gap: 12,
      justifyContent: 'center',
...
function App() {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Nav, {
    theme: theme,
    setTheme: setTheme
  }), React.createElement(FAQ, null), React.createElement(ClosingCTA, null), React.createElement(Footer, null), React.createElement(TweakPanel, {
    accent: accent,
